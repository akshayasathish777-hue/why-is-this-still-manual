...
const panels = [
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-flame-yellow font-semibold">High</span>
        </div>
        <div className="flex items-center justify-between">
    ...
    content: (
      <ul className="space-y-3">
        <li className="flex items-start gap-3">
          <span className="w-1.5 h-1.5 rounded-full bg-flame-red mt-2 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <ul className="space-y-3">
        <li className="flex items-start gap-3">
          <span className="w-1.5 h-1.5 rounded-full bg-flame-orange mt-2 shrink-0" />
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div className="flex items-center gap-3 p-3 rounded-lg bg-flame-yellow/5 border border-flame-yellow/20">
          <span className="w-6 h-6 rounded-full bg-flame-yellow/20 flex items-center justify-center text-flame-yellow text-sm font-bold">1</span>
          <span className="text-white/80">Set up email parsing integration</span>
        </div>
        <div className="flex items-center gap-3 p-3 rounded-lg bg-flame-yellow/5 border border-flame-yellow/20">
          <span className="w-6 h-6 rounded-full bg-flame-yellow/20 flex items-center justify-center text-flame-yellow text-sm font-bold">2</span>
          <span className="text-white/80">Configure data templates</span>
        </div>
        <div className="flex items-center gap-3 p-3 rounded-lg bg-flame-yellow/5 border border-flame-yellow/20">
          <span className="w-6 h-6 rounded-full bg-flame-yellow/20 flex items-center justify-center text-flame-yellow text-sm font-bold">3</span>
...
const Dashboard = ({ onViewChange }: DashboardProps) => {
  return (
    <div className="min-h-screen flex flex-col px-6 py-8 md:py-12">
      ...
      {/* Bento Grid */}
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 flex-1">
